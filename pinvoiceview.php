...
@media only screen and (max-width: 1149px),
  ...
  <div class="oborder print-container" ">
	...
	$sql2="select * from place_order where invoice_num=$pinvoice ";
...
include("connect.php");
	$sql1="select * from order_details where invoice_num=$pinvoice  ";
...
while($row=mysqli_fetch_array($data))
{
	...
	?>
            ...
            <td class="unit">Rs <?php echo $row['pro_price']; ?> /-</</td>
...
include("connect.php");
	$sql1="select SUM(pro_amt) , SUM(pro_qty) from order_details where invoice_num=$pinvoice ";
